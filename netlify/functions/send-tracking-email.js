...
exports.handler = async (event) => {
  ...
  if (!emailCliente || !codigoRastreio) {
    return { statusCode: 400, headers, body: JSON.stringify({ error: "emailCliente e codigoRastreio sao obrigatorios" }) };
  }
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <div style="background:#f0fdf4;border:2px dashed #86efac;border-radius:12px;padding:24px;text-align:center;margin:0 0 24px;">
                <p style="margin:0 0 6px;font-size:11px;font-weight:700;color:#166534;text-transform:uppercase;letter-spacing:1px;">
                  Código de Rastreio
                </p>
                <p style="margin:0;font-size:28px;font-weight:900;color:#15803d;letter-spacing:4px;font-family:monospace;">
                  ${codigoRastreio}
                </p>
              </div>
